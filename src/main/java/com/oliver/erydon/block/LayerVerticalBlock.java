...
public class LayerVerticalBlock extends Block implements Waterloggable {
    ...
    private static int idx(Direction d) {
        return switch (d) {
            ...
            case WEST  -> 2;
            case EAST  -> 3;
            default    -> 0; // NORTH and vertical directions
        };
    }

    public LayerVerticalBlock(Settings settings) {
    ...
    public boolean canReplace(BlockState state, ItemPlacementContext ctx) {
        ...
        if (side.getAxis().isHorizontal()) {
            ...
            // Clicking top/bottom: qualify stacking using the player's horizontal facing.
    ...
    public BlockState getPlacementState(ItemPlacementContext ctx) {
        ...
        // Handle stacking onto an existing block of the same type.
